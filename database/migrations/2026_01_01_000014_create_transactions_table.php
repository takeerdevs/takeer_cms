...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->enum('type', ['order_revenue', 'platform_fee', 'provider_payout', 'provider_refund']);
            ...
            $table->string('reference')->nullable()->unique()->comment('External PSP reference or order audit reference');
            $table->timestamps();
