        ...
        return [
            ...
            'merchant' => $this->whenLoaded('merchant', fn() => [
                ...
                'locations' => $this->merchant->relationLoaded('locations') ? $this->merchant->locations->map(fn($loc) => [
                    ...
                    'pickup_hold_hours' => (int) ($loc->pickup_hold_hours ?: 2),
                    'pickup_grace_hours' => (int) ($loc->pickup_grace_hours ?? 0),
                    'pickup_available_windows' => $loc->pickup_available_windows,
                    'pickup_instructions' => $loc->pickup_instructions,
                    'pickup_holding_fee_enabled' => (bool) $loc->pickup_holding_fee_enabled,
                    'pickup_late_fee_type' => $loc->pickup_late_fee_type ?: 'fixed',
                    'pickup_holding_fee_amount' => $loc->pickup_holding_fee_amount !== null ? (float) $loc->pickup_holding_fee_amount : null,
                    'pickup_late_fee_cap_amount' => $loc->pickup_late_fee_cap_amount !== null ? (float) $loc->pickup_late_fee_cap_amount : null,
                    'pickup_cancellation_penalty_percent' => $loc->pickup_cancellation_penalty_percent !== null ? (float) $loc->pickup_cancellation_penalty_percent : 0,
                    'pickup_holding_fee_interval' => $loc->pickup_holding_fee_interval,
                    'pickup_max_holding_days' => (int) ($loc->pickup_max_holding_days ?? 2),
