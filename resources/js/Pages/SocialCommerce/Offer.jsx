            ...
            <div className="mx-auto max-w-2xl space-y-5 px-4 pb-24 pt-6 sm:pt-10">
                ...
                <Card>
                    <CardHeader className="border-b border-border/70 bg-emerald-50/50">
                        <div className="flex items-center gap-2 text-xs font-black uppercase tracking-wider text-emerald-700"><CheckCircle2 className="h-4 w-4" />{copy('Seller-confirmed offer', 'Offer iliyothibitishwa na Muuzaji')}</div>
