...
export default function AppHeader() {
    const { url } = usePage();
    const pathname = typeof window !== 'undefined' ? window.location.pathname : String(url || '').split('?')[0];
    const showsOnlineBuyBanner = pathname === '/' || pathname === '/feed';
